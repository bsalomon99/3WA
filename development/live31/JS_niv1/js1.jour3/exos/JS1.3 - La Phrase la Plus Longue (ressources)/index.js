...
let iLonguestPhrase = 0;

for(let i = 0; i < phrases.length; i++)

{if(phrases[i].length > phrases[iLonguestPhrase].length) {
    ...
    document.write(`<p>La phrase la plus longue est : ${phrases[iLonguestPhrase]}</p> `);
   document.write(`<p>Elle contient ${phrases[iLonguestPhrase].length} caractères.</p> `);
